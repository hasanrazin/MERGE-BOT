...
if __name__ == "__main__":
    ...
    mergeApp.run()from dotenv import load_dotenv
...
🔰 ᴏᴡɴᴇʀ ᴄᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/BongoBondhuSheikhMujiburRahman")],
                [
                    InlineKeyboardButton(
                        "🏘Source Code🏘", url="https://t.me/BongoBondhuSheikhMujiburRahmanT"
                    ),
                    InlineKeyboardButton(
                        "🤔Deployed By🤔", url=f"https://t.me/{Config.OWNER_USERNAME}"
                    ),
...
if __name__ == "__main__":
    ...
    try:
        with userBot:
            userBot.send_message(
                chat_id=int(LOGCHANNEL),
                text="Bot booted with Premium Account,\n\n  Thanks for using <a href='https://t.me/BongoBondhuSheikhMujiburRahman'>Give Thanks</a>",
                disable_web_page_preview=True,
            )
            user = userBot.get_me()
            Config.IS_PREMIUM = user.is_premium
